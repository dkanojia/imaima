...
<section class="content">
			...
			<tr class="tableheading" style="font-weight:bold;">
					...
					<td colspan='6' align='left'><a href='addoffer.php'>Add New Offer</a></td>
					</tr>
<tr class="tableheading" style="font-weight:bold;">
<td>Sno</td>
<td>Offer Name</td>
...
$query = "select a.* from tbloffer a where a.bstatus=1 ";

$total->stmt = $query;
$total->execute();
$count = $total->getNumRows();

$query1 = $query. " order by a.blockstatus,a.offertype,a.offercode limit ".$start.",".$limit;
$cat->stmt = $query1;
$cat->execute();
$i = $start + 1;
	...
	echo "<td>".$i."</td>";	
	echo "<td>".$offername."</td>";	
    echo "<td><a href='addoffer.php?id=".$offerid."'>".$offercode."</a></td>";
    echo "<td>".$offertype."</td>";
	 echo "<td>".$offervalue."</td>";
    echo "<td>".$blockstatus."</td>";
    echo "<td><a href='addoffer.php?id=".$offerid."'>Edit</a><br /></td>";
    echo "</tr>";
    $i = $i + 1;
	}
?>
