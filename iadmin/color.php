...
<script language="javascript" type="text/javascript">
					...
					function getproducts()
					{
						...
						location.href="color.php?catid="+catid;
						
					}
				
					function confirmfunction()
					{
					return confirm("Are you sure to delete this Color");
					}
...
$page = isset($_GET['p']) ? ((int) $_GET['p']) : 1;
	...
	?>
			...
			<?php
					...
					<td colspan='2' align='left'><a href='addcolor.php'>Add New Color</a></td>
					</tr>
<tr class="tableheading" style="font-weight:bold;">
<td>Sno</td>
<td>Category</td>
...
$cat = new mysql();
$total = new mysql();
$query = "select a.*,b.catname from tblcolor a left outer join tblcategory b on a.catid=b.catid where a.bstatus=1 ";
if(isset($_REQUEST["catid"]))
...
$query1 = $query. " order by b.catname,a.colorname limit ".$start.",".$limit;
$cat->stmt = $query1;
$cat->execute();
$i = $start + 1;
	...
	echo "<td>".$i."</td>";	
	echo "<td>".$catname."</td>";	
    echo "<td><a href='addcolor.php?id=".$colorid."'>".$colorname."</a></td>";
    echo "<td>".$colordesc."</td>";
    echo "<td>".$blockstatus."</td>";
    echo "<td><a href='addcolor.php?id=".$colorid."'>Edit</a><br /></td>";
    echo "</tr>";
    $i = $i + 1;
	}
?>
