...
<script language="javascript" type="text/javascript">
					...
					function getproducts()
					{
						...
						location.href="style.php?catid="+catid;
...
$page = isset($_GET['p']) ? ((int) $_GET['p']) : 1;
	...
	?>
			...
			<?php
					...
					<td colspan='2' align='left'><a href='addstyle.php'>Add New Style</a></td>
					</tr>
<tr class="tableheading" style="font-weight:bold;">
<td>Sno</td>
<td>Category</td>
...
$cat = new mysql();
$total = new mysql();
$query = "select a.*,b.catname from tblstyle a left outer join tblcategory b on a.catid=b.catid where a.bstatus=1 ";
if(isset($_REQUEST["catid"]))
...
$query1 = $query. " order by b.catname,a.stylename limit ".$start.",".$limit;
$cat->stmt = $query1;
$cat->execute();
$i = $start + 1;
	...
	echo "<td>".$i."</td>";	
	echo "<td>".$catname."</td>";	
    echo "<td><a href='addstyle.php?id=".$styleid."'>".$stylename."</a></td>";
    echo "<td>".$styledesc."</td>";
    echo "<td>".$blockstatus."</td>";
    echo "<td><a href='addsize.php?id=".$styleid."'>Edit</a><br /></td>";
    echo "</tr>";
    $i = $i + 1;
	}
?>
