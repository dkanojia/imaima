...
if(isset($_POST["orderNo"]))
{
	  $update_table = new mysql(); 
       $query="UPDATE tblorder SET orderstatus='Cancel' WHERE orderid='".$_POST['orderNo']."' and orderstatus in ('Payment Incomplete','pending')";
...
<div id="pageWrap">
	<section id="content" class="contact">
                ...
                <div id="contactForm">
				 ...
				 $query = "select a.*,b.* from tblorder a inner join tbluser b on a.userid=b.nid where a.orderid='".$_POST["orderNo"]."'";
