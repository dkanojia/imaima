...
var featuredimagezoomer={
	...
	dsetting: { //default settings
			...
			cursorshade: false,
			leftoffset: 25, //offsets here are used (added to) the width of the magnifyarea when
	...
	init: function($, $img, options){
		...
		$magnifier=$('<div class="magnifyarea" style="position:absolute;width:'+setting.magnifiersize[0]+'px;height:'+setting.magnifiersize[1]+'px;left:-10000px;top:-10000px;visibility:hidden;overflow:hidden;border:1px solid #DBDBDB;" />')
