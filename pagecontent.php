...
{
$origpagename = $page->getorigwithspacestring($_REQUEST['name']);
 $query = "select * from tblpage_content where pagename='".$origpagename."' and blockstatus='active' and bstatus=1";
   $page->stmt = $query;
		  $page->execute();
